...
```r
animals <- list("Animals", list("Domesticated", list("Horse", "Cat", "Dog")), 
    list("Wild", list("Lion", "Tiger", "Bear", "Moose")), list("Non-Animals", 
        list("Bailey")))
...
ourTree <- list("The World", list("Non-Continental", list("Fiji", "New Zealand")), 
    list("Continental", list("Africa", list("Ghana", "Kenya", "Morocco")), list("Americas", 
        list("North", list("Canada", "Mexico")), list("South", list("Chile", 
            "Bolivia"))), list("Antarctica"), list("Asia", list("Thailand", 
        "Bhutan", "Mongolia")), list("Australia"), list("Europe", list("Slovakia", 
        "Romania"))))
